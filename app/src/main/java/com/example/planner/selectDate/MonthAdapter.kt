package com.example.planner.selectDate
...
class MonthAdapter(var deleteListener : OnClickListener,var editListener : OnClickListener) : ListAdapter<EventProperty, MonthAdapter.EventPropertyViewHolder>(DiffCallback) {
